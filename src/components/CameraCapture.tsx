...
/**
 * Cámara a pantalla completa con captura continua: abre el video una sola vez
 * y permite sacar foto tras foto. Cada disparo llama a onCapturar(blob).
 */
        ...
        <>
          ...
          <div className="safe-bottom flex items-center justify-between gap-4 bg-black px-8 py-5">
            <div className="w-24 text-sm text-white/70">
              {conteo > 0 ? 'Toque ✓ al terminar' : 'Encuadre y dispare'}
            </div>
            <button
              onClick={disparar}
              disabled={!listo}
