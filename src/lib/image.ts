 ...
 * BORDES (no por brillo). El comprobante está lleno de texto y líneas; la mesa
 * de fondo es lisa. Esto funciona aunque el papel sea blanco sobre un fondo
 * claro (donde el brillo no los distingue).
 *
 ...
 * texto claro (entonces el editor arranca con un recuadro por defecto). Es
 * liviano (una pasada por la imagen a baja resolución): nunca congela.
 */
