...
export function activarAutoActualizacion(): void {
  ...
  // control -> recargamos para mostrar la versión nueva. La ÚNICA excepción es
  // la "toma inicial" de la primera visita (aún no había controlador): esa no
  // debe recargar, para no parpadear al abrir por primera vez.
